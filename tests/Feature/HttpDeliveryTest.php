...
/**
 * Verifies HTTP deliveries record responses, propagate consumer-configured headers, and translate transport conditions into relay failures.
 *
...
class HttpDeliveryTest extends TestCase
{
    ...
    public function test_http_entrypoint_enforces_payload_limit(): void
    {
        ...
        $limit = (int) config('atlas-relay.payload_max_bytes', 64 * 1024);
